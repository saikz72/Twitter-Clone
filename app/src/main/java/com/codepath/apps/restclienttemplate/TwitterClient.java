...
public class TwitterClient extends OAuthBaseClient {
	...
	public void favoriteTweet(boolean favorited, long uid, JsonHttpResponseHandler handler) {
	...
	public void retweetTweet(boolean retweeted, long uid, JsonHttpResponseHandler handler) {
